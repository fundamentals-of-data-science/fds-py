...
coverage: ## check code coverage quickly with the default Python
	coverage run --source fundamentals_of_data_science -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\fundamentals_of_data_science.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs fundamentals_of_data_science
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
